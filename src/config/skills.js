export const skillsByCategories = [
  {
    ...
    skills: [
      ...
      },
      {
        ...
        title:
          "CSS3 is used with HTML to create and format content structure. It is responsible for colours, font properties, text alignments, background images, graphics etc.",
      },
      {
        name: "C",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        title:
          "React Native is a popular JavaScript-based mobile app framework that allows to build natively-rendered mobile apps for iOS and Android.",
      },
      {
        name: "KonvaJS",
      ...
      {
        name: "React Konva",
        link: "https://konvajs.org/docs/react/index.html",
        title:
      ...
      },
      {
        ...
        title:
          "Fabric.js is a framework that makes it easy to work with HTML5 canvas element. It is an interactive object model on top of canvas element.",
      },
      {
        name: "NestJS",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        title: 'PostgreSQL, often simply "Postgres", is an object-relational database management system (ORDBMS) with an emphasis on extensibility and standards-compliance.',
      },
      {
        name: "MongoDB",
